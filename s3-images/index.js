        ...
        this.s3()
          .putObject(config, (err, data) => {
            if (err) {
              ...
              // TODO: Get this from @try-ghost/constants
    ...
    return (req, res, next) =>
      this.s3()
        .getObject({
          ...
          // req.path = /content/images/2024/01/some-image.jpeg
          // Key: stripLeadingSlash(stripEndingSlash(this.pathPrefix) + '/2023/06/Gunbluster-Marked.jpg')
        })
